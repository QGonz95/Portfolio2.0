...
function Skills() {
  ...
  return (
    <div id="Skills" className="p-3 pb-32  md:p-4 md:pb-20">
      <div className="pt-16 text-2xl font-bold text-center text-gray-700">
        Transferable Skills
        <div>
          <div>
            <Fragment className="border-none">
              <Accordion open={open === 1} animate={customAnimation} className="border-b border-blue-gray-100">
                <AccordionHeader onClick={() => handleOpen(1)} className="text-xl md:text-2xl text-blue border-none">
                  Communication
                </AccordionHeader>
                <AccordionBody className="md:text-lg px-9">
              ...
              <Accordion open={open === 2} animate={customAnimation} className="border-b border-blue-gray-100">
                <AccordionHeader onClick={() => handleOpen(2)} className="text-xl md:text-2xl text-blue border-none">
                  Time Management
                </AccordionHeader>
                <AccordionBody className="md:text-lg px-9">
              ...
              <Accordion open={open === 3} animate={customAnimation} className="border-b border-blue-gray-100">
                <AccordionHeader onClick={() => handleOpen(3)} className="text-xl md:text-2xl text-blue border-none">
                  Attention to Detail
                </AccordionHeader>
                <AccordionBody className="md:text-lg px-9">
              ...
              <Accordion open={open === 4} animate={customAnimation} className="border-b border-blue-gray-100">
                <AccordionHeader onClick={() => handleOpen(4)} className="text-xl md:text-2xl text-blue border-none">
                  Adaptability
                </AccordionHeader>
                <AccordionBody className="md:text-lg px-9">
