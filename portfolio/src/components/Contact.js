...
function Contact() {
  ...
  return (
    <div id="Contact" className="container mx-auto px-4 lg:max-w-7xl pb-10 md:pb-4">
      <div class="p-3 space-y-8  md:p-5 md:space-y-5 drop-shadow shadow-inner shadow-dg">
